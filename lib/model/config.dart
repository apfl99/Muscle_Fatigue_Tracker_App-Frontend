...
class BaselineConstants {
  ...
  // 기본 Baseline 값
  static const double defaultRmsBase = 0.1;
  static const double defaultFreqBase = 10.0;
}
...
class FatigueConstants {
  ...
  static const double alpha = 0.6; // RMS 가중치
  static const double beta = 0.4; // 주파수 가중치
